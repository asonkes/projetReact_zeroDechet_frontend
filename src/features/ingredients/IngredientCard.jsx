...
export const IngredientCard = (props) => {
  ...
  return (
    <li
      className={`relative flex flex-col w-[18rem] h-17-375 mx-auto odd:bg_ingredient1 even:bg_ingredient2 bg-no-repeat bg-cover bg-center rounded-lg z-1 border-4 border-blue-500 transition-all duration-500 ${active ? `h-21-75` : `h-17-375`}`}
    >
